...
import md.cd.dining_philosophers.runnables.BlockingPhilosopher;
...
public final class BlockingDemoApp
{
    ...
    public void main(final int seconds) throws InterruptedException
    {
        ...
        final List<BlockingPhilosopher> runnables = philosophers.stream().map(
                philosopher -> BlockingPhilosopher.builder().
